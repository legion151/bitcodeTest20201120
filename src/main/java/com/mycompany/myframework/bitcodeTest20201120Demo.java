 ...
 * This class will be exposed by bitcodeTest20201120_instance() call in objc world
 * Use it as Facade to get access to other Framework functionalities
 */
@CustomClass("bitcodeTest20201120Demo")
public class bitcodeTest20201120Demo extends NSObject {
    /*
    ...
    public bitcodeTest20201120Demo() {
    ...
    public bitcodeTest20201120Demo(String text) {
